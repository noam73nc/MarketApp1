...
with st.expander("📖 מדריך קריאה למשתמש (Cheat Sheet) - לחץ לפתיחה", expanded=False):
    ...
    <p>הציון נע בין 1.0 ל-10.0, מדרג את עוצמת הסטאפ, ומחושב כך:</p>
    <ul>
        <li><b>עוצמה יחסית (עד 4.0 נק'):</b> תרגום של דירוג ה-RS של המניה לציון.</li>
        <li><b>מגמת מאקרו (2.0 נק'):</b> ניתן אוטומטית למניות הנמצאות ב-Stage 2.</li>
        <li><b>טיימינג ותבניות (עד 3.0 נק'):</b> תוספת של נקודה על כל תבנית מוסדית חיובית שזוהתה (EP, HVC וכו').</li>
        <li><b>בונוס התכווצות (1.0 נק'):</b> נקודת זהב המוענקת למניות בסחיטה מירבית (True VCP / Tight).</li>
        <li><b>קנסות אזהרה (-1.0 נק'):</b> הפחתה על תבניות שליליות (כמו SQUAT או מתיחות יתר).</li>
    </ul>
